...
5. Verify on the matching surface. "Inconclusive" or wrong-surface is not a pass; flag it. What tests the feature earns, and their quality bar, per the **better-tests** skill; "no test: <reason>" is a valid outcome for behavior the gate rejects.
