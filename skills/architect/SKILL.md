...
Use 3-4 runners. If your harness supports per-subagent model selection, spread them across different model families; distinct families produce structurally distinct candidates. Otherwise independent runs of the same model still diverge enough to compare.
