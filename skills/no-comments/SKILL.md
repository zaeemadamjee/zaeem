...
1. Spawn a subagent with the persona prompt in `references/comment-sicko.md`, passed verbatim, plus the scope. Do not restate its rules. If your harness has no subagents, adopt the persona yourself for a dedicated pass over the scope and produce the same report before continuing.
